...
modo.addEventListener ("click", function(){
    if (modo.className.includes("fa-sun")){
        ...
        document.documentElement.style.setProperty('--color-1', '#864788');
        document.documentElement.style.setProperty('--color-2', '#9e6ca0');
        document.documentElement.style.setProperty('--color-3', '#b691b8');
        document.documentElement.style.setProperty('--color-pagina','black');
        ...
        document.documentElement.style.setProperty('--color-1', '#a5aadf');
        document.documentElement.style.setProperty('--color-2', '#b7bbe5');
        document.documentElement.style.setProperty('--color-3', '#c9ccec');
